...
const Features = () => {
  return (
    <div  className="bg-[url('https://static.vecteezy.com/system/resources/previews/011/641/938/non_2x/blue-abstract-background-design-blue-corporate-background-use-for-business-corporate-institution-poster-template-party-festive-seminar-illustration-free-vector.jpg')]">
      <div className="px-4 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20 " >
  <div className="max-w-xl mb-10 md:mx-auto sm:text-center lg:max-w-2xl md:mb-12 text-white">
    <div>
      <p className="inline-block px-3 py-px mb-4 text-xs font-semibold tracking-wider text-white uppercase rounded-full text-white">
        Brand new
      </p>
    </div>
    <h2 className="max-w-lg mb-6 font-sans text-3xl font-bold leading-none tracking-tight text-white-100 sm:text-4xl md:mx-auto text-white">
      <span className="relative inline-block">
        <svg
          viewBox="0 0 52 24"
          fill="currentColor"
          className="absolute top-0 text-white left-0 z-0 hidden w-32 -mt-8 -ml-20 text-blue-gray-100 lg:w-32 lg:-ml-28 lg:-mt-10 sm:block"
        >
          <defs>
            <pattern
  ...
  <div className="grid gap-8 row-gap-10 lg:grid-cols-2">
    <div className="max-w-md sm:mx-auto sm:text-center">
      ...
      <h6 className="mb-3 text-xl text-white font-bold leading-5">Business Development Resources</h6>
    ...
    <div className="max-w-md sm:mx-auto sm:text-center">
      ...
      <h6 className="mb-3 text-xl text-white font-bold leading-5">On-Site Support Services</h6>
      <p className="mb-3 text-sm text-white">
    ...
    <div className="max-w-md sm:mx-auto sm:text-center">
      ...
      <h6 className="mb-3 text-xl text-white font-bold leading-5">Community and Networking Events</h6>
      <p className="mb-3 text-sm text-white">
    ...
    <div className="max-w-md sm:mx-auto sm:text-center">
      ...
      <h6 className="mb-3 text-xl text-white font-bold leading-5">Wellness and Recreation Areas</h6>
      <p className="mb-3 text-sm text-white">
...
<footer className="px-4 divide-y dark:bg-blue-950 dark:text-gray-800 mt-1">
